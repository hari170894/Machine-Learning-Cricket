...
#dict1 = {}
#dict1["recent_runrate"] = 0
#dict1["top_bowler1_curr"] = 0

#bc = pd.DataFrame(get_feature_vec(1,1,1))
#print bc
#print len(get_feature_vec(1,1,1))

#print get_ball_count_in_innings(1,1)
#print get_run_count_in_innings(1,1)
#print float(get_run_count_in_innings(1,1)) / ( float(get_ball_count_in_innings(1,1)) / 6 )

#deliveries.to_csv('example.csv')

# skip these mathces 242 487
#print get_run_rate_upto_over(1, 1, 1)
#print get_run_rate_upto_over(1, 1, 2)
#print get_run_rate_upto_oveget